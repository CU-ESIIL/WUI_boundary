...
The real-data figures and CSV assets on this page are generated by running the streaming script with `--publish-doc-assets`. If those files have not been generated in a given checkout yet, rerun the command documented on the methods page to publish them before interpreting this page.
