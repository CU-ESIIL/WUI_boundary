...
A first empirical pilot run using open OSM and streamed NLCD inputs is now documented on the dedicated [Real-data experiments](real-data-experiments.md) page.
