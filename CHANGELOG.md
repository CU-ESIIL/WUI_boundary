...
- Corrected `interface_length_m` in the streaming pipeline to measure the settlement-buffer interface front consistently (using buffered-settlement boundary intersection with vegetation), fixing CI failure in `test_interface_length_calculation`.
